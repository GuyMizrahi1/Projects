...
connector = rti.Connector("MyParticipantLibrary::TempSensor1Connector", filepath + "/DDS.xml")
outputDDS = connector.getOutput("TemperatureSensor1Pub::TempSensor1Writer")
input_DDS = connector.getInput("TemperatureSensor1Sub::TempSensor1Reader")
    ...
    for j in range(0, numOfSamples):
        if input_DDS.infos.isValid(j):
            ...
            while input_DDS.samples.getString(j, "StringMember") == "Working":
                ...
                outputDDS.write()
                sleep(0.1)
                print(f'Current Temperature at sensor 1: {temp}')
